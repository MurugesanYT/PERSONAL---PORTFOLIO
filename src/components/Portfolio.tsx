...
const Portfolio = () => {
  const projects = [
    ...
    },
    {
      ...
      description: "Craft a magical moment that will be remembered forever ✨. If you get the following error, please try again later (due to temporary database deactivation). DM me To Activate It.",
      category: "Web App",
      featured: true
    },
    {
